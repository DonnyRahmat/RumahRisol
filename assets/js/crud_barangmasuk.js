$(document).ready(function(){
  ...
  $('#example tbody').on('click', '#edit', function(){
   ...
   $.ajax({
        ...
        success:function(data){
             ...
             $('#id_detil_brgmsk').val(data.id_detil_brgmsk);
 ...
 $('#update').click(function(){
   var updId = $('#id_detil_brgmsk').val();
   var nmbar = $('#nmbarang_1').val(data.nama_barang);
   var stok = $('#stok_1').val(data.stok);
   var ukuran = $('#ukuran_1').val(data.uk);
   var harga_beli = $('#harga_beli_1').val(data.harga_brgmsk);
   var jml = $('.jml_brgmsk').val(data.jml_brgmsk);
   $.ajax({
       url:"insert_brgmsk.php",
       method:'POST',
       data:{
